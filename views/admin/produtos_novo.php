...
<div class="container mt-4">
    ...
    <form method="POST" action="<?= url('admin/produtos/salvar') ?>">
        <div class="row">
            <div class="col-md-8">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descricao_prod" name="descricao_prod" rows="4"></textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="categoria_id" name="categoria_id" value="1">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <img id="preview" src="https://via.placeholder.com/300x300?text=Sem+Imagem" class="img-fluid" alt="Preview">
                    </div>
                </div>
            </div>
        </div>
